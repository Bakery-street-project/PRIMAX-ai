        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "message": {
                        "type": "string",
                        "description": "Your message to PRIMAX",
                    },
                    "model": {
                        "type": "string",
                        "description": "Model to use (dragon, coding, wisdom)",
                        "default": "dragon",
                    },
                },
                "required": ["message"],
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "analysis_type": {
                        "type": "string",
                        "description": "Type: graph, snn, or dynamic",
                        "default": "graph",
                    }
                },
                "required": [],
...
async def handle_call_tool(
    ...
    if name == "primax_chat":
        ...
        return [
            TextContent(
                type="text",
                text=f"Brain {analysis_type} analysis: Neural network active",
            )
        ]
