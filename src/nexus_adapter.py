...
class NexusAdapter:
    ...
    async def dispatch_task(self, agent_name: str, task: str, context: Dict = None) -> Dict:
...
async def main():
    ...
    try:
        ...
        result = await adapter.dispatch_task(
            "scout-agent",
            "scan codebase",
            {"path": "/home/kilisan/primax-ai/src"}
        )
