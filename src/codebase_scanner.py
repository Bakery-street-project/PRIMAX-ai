...
class CodebaseScanner:
    ...
    def scan(self, recursive: bool = True, extensions: List[str] = None) -> ScanResult:
        if extensions is None:
            extensions = [".py", ".js", ".ts", ".go", ".rs", ".java", ".cpp", ".c", ".md"]
    ...
    def _analyze_python_file(self, content: str, file_path: Path, code_file: CodeFile) -> None:
        try:
    ...
    def _analyze_javascript_file(self, content: str, file_path: Path, code_file: CodeFile) -> None:
    ...
    def _analyze_go_file(self, content: str, file_path: Path, code_file: CodeFile) -> None:
