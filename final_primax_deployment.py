...
def check_ollama_models():
    ...
    try:
        ...
        for name, size in available_models.items():
            marker = "✅" if "optimus" in name.lower() or "dragon" in name.lower() else "📦"
...
def main():
    ...
    print(f"  🤖 Optimus Prime: {'✅ Available' if optimus_available else '⏳ Downloading'}")
    print(f"  🐉 Dragon Wise: {'✅ Ready' if dragon_available else '🔧 Needs training'}")
    print(f"  💾 Supabase: {'✅ Schema ready' if supabase_ok else '📋 Manual setup needed'}")
